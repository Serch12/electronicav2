...
<body class="theme-color-23">
    ...
    <section class="small-section small-slider pt-res-0">
        <div class="container">
            <div class="slider-animate home-slider">
                <div>
                    <div class="home">
                        <img src="assets/images/electronics/home-slider/1.jpg" alt=""
                                ...
                                <div class="no-slider row">
                                    ...
                                    <div class="product-box product-wrap">
                                        <div class="img-wrapper">
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img
                                                        src="assets/images/electronics/pro/30.jpg"
                                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                            </div>
                                            <div class="cart-box style-1 rounded-0">
                                                <button onclick="openCart()" title="Add to cart"><i
    ...
    <section class="container">
        <div class="full-banner small-banner text-center p-center">
            <img src="assets/images/electronics/banner/12.jpg" alt="" class="bg-img blur-up lazyload">
            <div class="container">
                <div class="row">
                    <div class="col">
            ...
            <div class="row partition2">
                <div class="col-md-6">
                    <a href="#">
                        <div class="collection-banner p-right text-center">
                            <div class="img-part">
                                <img src="assets/images/electronics/banner/10.jpg"
                                    class="img-fluid blur-up lazyload bg-img" alt="">
                            </div>
                ...
                <div class="col-md-6">
                    <a href="#">
                        <div class="collection-banner p-right text-center">
                            <div class="img-part">
                                <img src="assets/images/electronics/banner/11.jpg"
                                    class="img-fluid blur-up lazyload bg-img" alt="">
                            </div>
                            <div class="contain-banner">
                                <div>
