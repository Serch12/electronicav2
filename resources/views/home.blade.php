...
<body class="theme-color-23">
                    ...
                    <div class="product-5 product-m no-arrow">
                            ...
                            <div class="img-wrapper">
                                <div class="front">
                                    <a href="product-page(no-sidebar).html"><img
                                            src="{{ asset('assets/images/electronics/pro/19.jpg')}}"
                        ...
                        <div class="product-box product-wrap">
                            <div class="img-wrapper">
                                <div class="front">
                                    <a href="product-page(no-sidebar).html"><img
                                            src="{{ asset('assets/images/electronics/pro/20.jpg')}}"
                                            class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                                <div class="cart-box style-1 rounded-0">
                                    <button onclick="openCart()" title="Add to cart"><i
                        ...
                        <div class="product-box product-wrap">
                            <div class="img-wrapper">
                                <div class="front">
                                    <a href="product-page(no-sidebar).html"><img
                                            src="{{ asset('assets/images/electronics/pro/21.jpg')}}"
                                            class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                                <div class="cart-box style-1 rounded-0">
                                    <button onclick="openCart()" title="Add to cart"><i
                        ...
                        <div class="product-box product-wrap">
                            <div class="img-wrapper">
                                <div class="front">
                                    <a href="product-page(no-sidebar).html"><img
                                            src="{{ asset('assets/images/electronics/pro/22.jpg')}}"
                                            class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                                <div class="cart-box style-1 rounded-0">
                                    <button onclick="openCart()" title="Add to cart"><i
                        ...
                        <div class="product-box product-wrap">
                            <div class="img-wrapper">
                                <div class="front">
                                    <a href="product-page(no-sidebar).html"><img
                                            src="{{ asset('assets/images/electronics/pro/23.jpg')}}"
                                            class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                                <div class="cart-box style-1 rounded-0">
                                    <button onclick="openCart()" title="Add to cart"><i
                        ...
                        <div class="product-box product-wrap">
                            <div class="img-wrapper">
                                <div class="front">
                                    <a href="product-page(no-sidebar).html"><img
                                            src="{{ asset('assets/images/electronics/pro/24.jpg')}}"
                                            class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                                <div class="cart-box style-1 rounded-0">
                                    <button onclick="openCart()" title="Add to cart"><i
                            ...
                            <a href="#">
                                <div class="collection-banner tl-content">
                                    <div class="img-part custom-height">
                                        <img src="{{ asset('assets/images/electronics/banner/13.jpg')}}"
                                ...
                                <div class="row">
                                    <div class="col-12 mb-4">
                                        <a href="#">
                                            <div class="collection-banner">
                                                <div class="img-part">
                                                    <img src="{{ asset('assets/images/electronics/banner/15.jpg')}}"
                                                        class="img-fluid blur-up lazyload bg-img" alt="">
                                                </div>
                                                <div class="contain-banner banner-3">
                                                    <div>
                                    ...
                                    <div class="col-12">
                                        <a href="#">
                                            <div class="collection-banner">
                                                <div class="img-part">
                                                    <img src="{{ asset('assets/images/electronics/banner/14.jpg')}}"
                                                        class="img-fluid blur-up lazyload bg-img" alt="">
                                                </div>
                                                <div class="contain-banner banner-3">
                                                    <div>
                    ...
                    <div class="col-lg-3 col-12 d-lg-block d-none">
                        <div class="banner-goggles banner-padding pt-0">
                            <a href="#">
                                <div class="collection-banner tl-content">
                                    <div class="img-part custom-height">
                                        <img src="{{ asset('assets/images/electronics/banner/16.jpg')}}"
                                            class="img-fluid blur-up lazyload bg-img" alt="">
                                    </div>
                                    <div class="contain-banner banner-3">
                                        <div>
                                ...
                                <div class="no-slider row">
                                    <div class="product-box product-wrap">
                                        <div class="img-wrapper">
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img
                                                        src="{{ asset('assets/images/electronics/pro/25.jpg')}}"
                                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                            </div>
                                            <div class="cart-box style-1 rounded-0">
                                                <button onclick="openCart()" title="Add to cart"><i
                                    ...
                                    <div class="product-box product-wrap">
                                        <div class="img-wrapper">
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img
                                                        src="{{ asset('assets/images/electronics/pro/26.jpg')}}"
                                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                            </div>
                                            <div class="cart-box style-1 rounded-0">
                                                <button onclick="openCart()" title="Add to cart"><i
                                        ...
                                        <div class="product-detail">
                                            ...
                                            <a href="product-page(no-sidebar).html">
                                                <h6>Wireless Bluetooth Twin Connect Speaker</h6>
                                            </a>
                                            <h4>$95.50</h4>
                                            <ul class="color-variant">
                                                <li class="bg-color1"></li>
                                    ...
                                    <div class="product-box product-wrap">
                                        <div class="img-wrapper">
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img
                                                        src="{{ asset('assets/images/electronics/pro/27.jpg')}}"
                                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                            </div>
                                            <div class="cart-box style-1 rounded-0">
                                                <button onclick="openCart()" title="Add to cart"><i
                                        ...
                                        <div class="product-detail">
                                            ...
                                            <a href="product-page(no-sidebar).html">
                                                <h6>Wireless Bluetooth Speaker</h6>
                                            </a>
                                            <h4>$100.20</h4>
                                            <ul class="color-variant">
                                                <li class="bg-color1"></li>
                                    ...
                                    <div class="product-box product-wrap">
                                        <div class="img-wrapper">
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img
                                                        src="{{ asset('assets/images/electronics/pro/28.jpg')}}"
                                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                            </div>
                                            <div class="cart-box style-1 rounded-0">
                                                <button onclick="openCart()" title="Add to cart"><i
                                    ...
                                    <div class="product-box product-wrap">
                                        <div class="img-wrapper">
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img
                                                        src="{{ asset('assets/images/electronics/pro/29.jpg')}}"
                                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                            </div>
                                            <div class="cart-box style-1 rounded-0">
                                                <button onclick="openCart()" title="Add to cart"><i
                                    ...
                                    <div class="product-box product-wrap">
                                        <div class="img-wrapper">
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img
                                                        src="{{ asset('assets/images/electronics/pro/30.jpg')}}"
                                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                            </div>
                                            <div class="cart-box style-1 rounded-0">
                                                <button onclick="openCart()" title="Add to cart"><i
                                        ...
                                        <div class="product-detail">
                                            ...
                                            <a href="product-page(no-sidebar).html">
                                                <h6>Alexa Wireless Bluetooth Speakers</h6>
                                            </a>
                                            <h4>$250.30</h4>
                                            <ul class="color-variant">
                                                <li class="bg-color1"></li>
                                    ...
                                    <div class="product-box product-wrap">
                                        <div class="img-wrapper">
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img
                                                        src="{{ asset('assets/images/electronics/pro/31.jpg')}}"
                                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                            </div>
                                            <div class="cart-box style-1 rounded-0">
                                                <button onclick="openCart()" title="Add to cart"><i
    ...
    <section class="container">
        <div class="full-banner small-banner text-center p-center">
            <img src="{{ asset('assets/images/electronics/banner/12.jpg')}}" alt="" class="bg-img blur-up lazyload">
            <div class="container">
                <div class="row">
                    <div class="col">
    ...
    <!-- collection banner -->
    <section class="ratio2_1 banner-padding">
        <div class="container">
            <div class="row partition2">
                <div class="col-md-6">
                    <a href="#">
                        <div class="collection-banner p-right text-center">
                            <div class="img-part">
                                <img src="{{ asset('assets/images/electronics/banner/10.jpg')}}"
                                    class="img-fluid blur-up lazyload bg-img" alt="">
                            </div>
                ...
                <div class="col-md-6">
                    <a href="#">
                        <div class="collection-banner p-right text-center">
                            <div class="img-part">
                                <img src="{{ asset('assets/images/electronics/banner/11.jpg')}}"
                                    class="img-fluid blur-up lazyload bg-img" alt="">
                            </div>
                            <div class="contain-banner">
                                <div>
                                ...
                                <div class="no-slider five-product row">
                                    <div class="product-box product-wrap">
                                        <div class="img-wrapper">
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img
                                                        src="{{ asset('assets/images/electronics/pro/32.jpg')}}"
                                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                            </div>
                                            <div class="cart-box style-1 rounded-0">
                                                <button onclick="openCart()" title="Add to cart"><i
                    ...
                    <div class="slide-6 no-arrow">
                        <div>
                            <div class="logo-block">
                                <a href="#"><img src="{{ asset('assets/images/logos/1.png')}}" alt=""></a>
                            </div>
                        </div>
                        <div>
                            <div class="logo-block">
                                <a href="#"><img src="{{ asset('assets/images/logos/2.png')}}" alt=""></a>
                            </div>
                        </div>
                        <div>
                            <div class="logo-block">
                                <a href="#"><img src="{{ asset('assets/images/logos/3.png')}}" alt=""></a>
                            </div>
                        </div>
                        <div>
                            <div class="logo-block">
                                <a href="#"><img src="{{ asset('assets/images/logos/4.png')}}" alt=""></a>
                            </div>
                        </div>
                        <div>
                            <div class="logo-block">
                                <a href="#"><img src="{{ asset('assets/images/logos/5.png')}}" alt=""></a>
                            </div>
                        </div>
                        <div>
                            <div class="logo-block">
                                <a href="#"><img src="{{ asset('assets/images/logos/6.png')}}" alt=""></a>
                            </div>
                        </div>
                        <div>
                            <div class="logo-block">
                                <a href="#"><img src="{{ asset('assets/images/logos/7.png')}}" alt=""></a>
                            </div>
                        </div>
                        <div>
                            <div class="logo-block">
                                <a href="#"><img src="{{ asset('assets/images/logos/8.png')}}" alt=""></a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="theme-settings">
        <ul>
            ...
            <li class="input-picker">
                <input id="ColorPicker1" type="color" value="#2874f0" name="Background">
            </li>
        </ul>
    </div>
