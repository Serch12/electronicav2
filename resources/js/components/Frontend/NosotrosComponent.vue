<template>
    ...
    <section class="vendor-profile pt-0">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="profile-left shadow-lg">
                        <div class="profile-image">
                            <div>
                                <img src="assets/images/logos/vision.jpg" alt="" class="img-fluid">
                                <h3>Misión</h3>
                            </div>
                        </div>
                        <div class="profile-detail">
                            <div>
                                <p>Based in United States, Fashion store has been an Multikart member since May 15,
                                    2017.
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="profile-left shadow-lg">
                        <div class="profile-image">
                            <div>
                                <img src="assets/images/logos/mision.png" alt="" class="img-fluid">
                                <h3>Visión</h3>
                            </div>
                        </div>
                        <div class="profile-detail">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="profile-left shadow-lg">
                        <div class="profile-image">
                            <div>
                                <img src="assets/images/logos/valores.jpg" alt="" class="img-fluid">
                                <h3>Valores</h3>
                            </div>
                        </div>
                        <div class="profile-detail">
