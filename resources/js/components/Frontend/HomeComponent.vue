<template>
        ...
        <div class="slide-1 home-slider">
            <div>
                <div class="home  text-center">
                    <img src="assets/images/logos/fondo5.jpeg" alt="" class="bg-img blur-up lazyload">
                    <div class="container">
                        <div class="row">
                            <div class="col">
            ...
            <div>
                <div class="home text-center">
                    <img src="assets/images/logos/fondo7.jpeg" alt="" class="bg-img blur-up lazyload">
                    <div class="container">
                        <div class="row">
                            <div class="col">
                                <div class="slider-contain">
  ...
  <a class="carousel-control-next" href="#carouselExampleIndicators" role="button" data-slide="next">
                ...
                <div class="col-md-4 service-block">
                    <div class="media">
                        ...
                        <div class="media-body">
                            <h4>Cotiza productos</h4>
                            <p>Genera tu cotización en productos de tu interés.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 service-block">
                    <div class="media">
                        ...
                        <div class="media-body">
                            ...
                            <p>Servicio en línea para nuevos clientes.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 service-block">
                ...
                <div class="row">
                    <div class="col">
                        <div class="banner-contain">
                            <h2>2023</h2>
                            <h3>Imagen de alguna promo</h3>
                            <h4>algún producto</h4>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="title1 section-t-space">
        <h4></h4>
        <h2 class="title-inner1">Productos</h2>
    </div>
    <section class="section-b-space pt-0 ratio_asos">
        <div class="container">
            <div class="row">
                <div class="col">
                    <div class="theme-tab">
                        <ul class="tabs tab-title">
                            <li class="current"><a href="tab-4">Ver catálogo</a></li>
                        </ul>
                        <div class="tab-content-cls">
                            <div id="tab-4" class="tab-content active default" >
                                <div class="no-slider row">
                                    <div class="product-box" v-for="(p,index) in productos" :key="index">
                                        <div class="img-wrapper">
...
export default {
    ...
    methods:{
        inicio(){
            axios.get('inicio/productos').then(res =>{
                this.nuevos_productos = res.data.nuevos_productos;
